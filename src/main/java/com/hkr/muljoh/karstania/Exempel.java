...
public class Exempel extends AppCompatActivity {
    ...
    private String textTitel =  "Kapitel x";
    ...
    public void klickaKnapp(View view) {
        ...
        Intent myIntent = new Intent(Exempel.this, Exempel.class);
        myIntent.putExtra("meddelande", value);
        Exempel.this.startActivity(myIntent);
    }
}
