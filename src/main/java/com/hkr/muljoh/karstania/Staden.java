...
public class Staden extends AppCompatActivity {
    ...
    private String textTitel =  "Staden";
    ...
    public void klickaKnapp(View view) {
        ...
        Intent myIntent = new Intent(Staden.this, Staden.class);
        myIntent.putExtra("meddelande", value);
        Staden.this.startActivity(myIntent);
    }
}
