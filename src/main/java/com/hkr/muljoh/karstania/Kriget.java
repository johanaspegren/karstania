...
public class Kriget extends AppCompatActivity {
    ...
    private String textTitel =  "Kriget";
    ...
    public void klickaKnapp(View view) {
        ...
        Intent myIntent = new Intent(Kriget.this, Kriget.class);
        myIntent.putExtra("meddelande", value);
        Kriget.this.startActivity(myIntent);
    }
}
