...
public class Alvskogen extends AppCompatActivity {
    ...
    private String textTitel =  "Alvskogen";
    ...
    public void klickaKnapp(View view) {
        ...
        Intent myIntent = new Intent(Alvskogen.this, Alvskogen.class);
        myIntent.putExtra("meddelande", value);
        Alvskogen.this.startActivity(myIntent);
    }
}
