...
public class Grottan extends AppCompatActivity {
    ...
    private String textTitel =  "Grottan";
    ...
    public void klickaKnapp(View view) {
        ...
        Intent myIntent = new Intent(Grottan.this, Grottan.class);
        myIntent.putExtra("meddelande", value);
        Grottan.this.startActivity(myIntent);
    }
}
