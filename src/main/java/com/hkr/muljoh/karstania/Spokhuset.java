...
public class Spokhuset extends AppCompatActivity {
    ...
    private String textTitel =  "Spokhuset";
    ...
    public void klickaKnapp(View view) {
        ...
        Intent myIntent = new Intent(Spokhuset.this, Spokhuset.class);
        myIntent.putExtra("meddelande", value);
        Spokhuset.this.startActivity(myIntent);
    }
}
