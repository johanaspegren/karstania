...
public class Handelsboden extends AppCompatActivity {
    ...
    private String textTitel =  "Handelsboden";
    ...
    public void klickaKnapp(View view) {
        ...
        Intent myIntent = new Intent(Handelsboden.this, Handelsboden.class);
        myIntent.putExtra("meddelande", value);
        Handelsboden.this.startActivity(myIntent);
    }
}
