...
public class Slottet extends AppCompatActivity {
    ...
    private String textTitel =  "Slottet";
    ...
    public void klickaKnapp(View view) {
        ...
        Intent myIntent = new Intent(Slottet.this, Slottet.class);
        myIntent.putExtra("meddelande", value);
        Slottet.this.startActivity(myIntent);
    }
}
